...
Function getColumnIn2LevelHdr(targetRng As Range, hdrLevel1Str As String, Optional hdrLevel2Str As String = "") As Range
    ...
    If hdrLevel2Str <> "" Then ' задано имя второго уровня
        If Not destRng Is Nothing Then ' нашли ячейку
            ...
            ' ячейка во второй строке заголовка
    ...
    Else ' возвращаем только найденное в первой строке
        Set getColumnIn2LevelHdr = destRng
    End If
End Function